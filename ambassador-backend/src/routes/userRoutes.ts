...
router.get('/notifications', verifyToken, grantAccess(['admin', 'coordinador']), userController.notifications);
router.put('/notifications/:id/read', verifyToken, grantAccess(['admin', 'coordinador']), userController.markNotificationRead);
